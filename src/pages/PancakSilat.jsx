    ...
    <div className="OlimpiadeSMP-container">
      ...
      <section className="penghargaan-container-atas">
        <div className="penghargaan-row red-bg">
          <div className="penghargaan-text">
            ...
            <p>
              Penghargaan untuk mereka yang terpilih menjadi JUARA PANCAK SILAT
      ...
      <section className="penghargaan-container-bawah">
        <div className="penghargaan-row">
          <div className="penghargaan-text">
            <h3>PENGHARGAAN</h3>
            <p className="sub">JUARA PANCAK SILAT</p>
            <p>
              Piala yang diberikan kepada anak yang mendapatkan gelar JUARA PANCAK
              SILAT dilakukan pada saat ATLANTIS TALENT DAY, yang diberikan
              oleh pembimbing.
            </p>
