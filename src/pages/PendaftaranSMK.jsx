  ...
  return (
    <div className="pendaftaran-container">
      ...
      <div className="ppdb-tutup-box">
        <div className="ppdb-tutup-icon-wrap">
          <span className="ppdb-tutup-icon">🔒</span>
        </div>
        <h3>PPDB SMK Telah Ditutup</h3>
        <div className="ppdb-tutup-divider"></div>
        <p>
