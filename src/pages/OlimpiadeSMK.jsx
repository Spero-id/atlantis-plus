      ...
      <section className="OlimpiadeSMP-hero">
        <div className="OlimpiadeSMP-hero-overlay">
          <h1 className="OlimpiadeSMP-hero-title">
            Olimpiade <br /> <span className="OlimpiadeSMP-teks">SMK</span>{" "}
            <span className="OlimpiadeSMP-teks1">ATLANTIS PLUS</span>
          </h1>
          <p className="OlimpiadeSMP-hero-subtitle">Nothing impossible in this word</p>
        </div>
      </section>
  ...
  <section className="penghargaan-container-atas">
    <div className="penghargaan-row red-bg">
      <div className="penghargaan-text">
        ...
        <p>
          Penghargaan untuk mereka yang terpilih menjadi THE BEST ENGLISH di
          setiap tahunnya, dinilai dari bagaimana kemampuan bahasa
          inggrisnya selama bersekolah juga pengambilan nilai bahasa
          inggrisnya dalam ujian juga dalam praktik UKM dengan itu kami
          memberikannya penghargaan berupa piala atas apa yang telah
          diraihnya.
        </p>
      </div>
